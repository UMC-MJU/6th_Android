...
public final class FragmentAlbumBinding implements ViewBinding {
  ...
  @NonNull
  public final CardView albumAlbumCv;
  ...
  @NonNull
  public final ImageView albumPlayIv;

  @NonNull
  public final TextView albumSingerNameTv;

  private FragmentAlbumBinding(@NonNull ConstraintLayout rootView, @NonNull CardView albumAlbumCv,
      ...
      @NonNull ImageView albumLikeIv, @NonNull ImageView albumLpIv, @NonNull ImageView albumMoreIv,
      @NonNull TextView albumMusicTitleInfoTv, @NonNull TextView albumMusicTitleTv,
      @NonNull ImageView albumPlayIv, @NonNull TextView albumSingerNameTv) {
    this.rootView = rootView;
    this.albumAlbumCv = albumAlbumCv;
  ...
  public static FragmentAlbumBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.album_album_cv;
      CardView albumAlbumCv = ViewBindings.findChildViewById(rootView, id);
      if (albumAlbumCv == null) {
        break missingId;
      }
      ...
      id = R.id.album_play_iv;
      ImageView albumPlayIv = ViewBindings.findChildViewById(rootView, id);
      if (albumPlayIv == null) {
        break missingId;
      }
      ...
      return new FragmentAlbumBinding((ConstraintLayout) rootView, albumAlbumCv, albumAlbumIv,
          albumBackIv, albumContentTb, albumContentVp, albumLikeIv, albumLpIv, albumMoreIv,
          albumMusicTitleInfoTv, albumMusicTitleTv, albumPlayIv, albumSingerNameTv);
    }
